...
car_Enemy = pygame.image.load('C:\pp2\edcar.png')
car_Own = pygame.image.load('C:\pp2\greencar.png')
bg = pygame.image.load('C:\pp2\AnimatedStreet.png')
...
class coin_generation(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.img = pygame.transform.scale(pygame.image.load('C:\pp2\coin.png'), (50,50))
...
class ownMovement(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.car = pygame.transform.scale(car_Enemy, (20, 50))
...
class enemyMovement(pygame.sprite.Sprite):
        def __init__(self):
            super().__init__()
            self.car = pygame.transform.scale(car_Own, (45, 90))
            self.rect = self.car.get_rect()
